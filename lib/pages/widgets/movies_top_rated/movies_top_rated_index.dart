...
class MoviesTopRatedIndexWidget extends StatefulWidget {
  const MoviesTopRatedIndexWidget({Key? key}) : super(key: key);

  @override
  State<MoviesTopRatedIndexWidget> createState() => _MoviesTopRatedIndexWidgetState();
}

class _MoviesTopRatedIndexWidgetState extends State<MoviesTopRatedIndexWidget> {
  ...
  void initState() {
    ...
    moviesBloc = MoviesBloc(listType: 'topRated', genre: null);
          ...
          if (state is MoviesIndexState) {
            return Column(
              children: [
                ...
                SizedBox(
                  height: 200,
                  child: MoviesTopRatedCarouselWidget(movies: state.movies),
                ),
              ],
            );
          }
